...
#pragma omp parallel for private(p_in, p_out)
        ...
        if (comp + 1 < components_ || !alignment_even)
        {
          ...
          MPI_Barrier(parallel.lat_world_comm());
          COUT << "Here transpose back 0 3 comp " << comp+(alignment_even ? 1 : 0) << endl;
          ...
          MPI_Barrier(parallel.lat_world_comm());
          COUT << "Here implement 0 comp " << comp+(alignment_even ? 1 : 0) << endl;
          ...
          MPI_Barrier(parallel.lat_world_comm());
          COUT << "Done transpose back 0 3 comp " << comp+(alignment_even ? 1 : 0) << endl;
          nvtxRangePop();
        }
        ...
        if (comp + 1 < components_ || alignment_even)
        {
          ...
          MPI_Barrier(parallel.lat_world_comm());
          COUT << "Here transpose back 0 3 comp " << comp+(alignment_even ? 0 : 1) << endl;
          ...
          MPI_Barrier(parallel.lat_world_comm());
          COUT << "Here implement 0 comp " << comp+(alignment_even ? 0 : 1) << endl;
          ...
          MPI_Barrier(parallel.lat_world_comm());
          COUT << "Done transpose back 0 3 comp " << comp+(alignment_even ? 0 : 1) << endl;
          nvtxRangePop();
        }
      }
    }
