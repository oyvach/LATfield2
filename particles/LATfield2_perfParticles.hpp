...
class perfParticles
{
    public:
        ...
        Real updateVel(UpdateFunct updateVel_funct, double dtau, Field<Real> ** fields = NULL, int nfields = 0, double * params = NULL, double * output = NULL,
                        int * reduce_type = NULL, int noutput = 0, void **vparams = NULL);
        // Move particles
        template <typename UpdateFunct>
        void moveParticles(UpdateFunct move_funct, double dtau, Field<Real> ** fields = NULL, int nfields = 0, double * params = NULL, double * output = NULL,
                        int * reduce_type = NULL, int noutput = 0, void **vparams = NULL);
        // density projection
    ...
    protected:
        ...
        template <typename UpdateFunct>
        void updateParticles(UpdateFunct update_funct, double dtau, Field<Real> ** fields = NULL, int nfields = 0, double * params = NULL,
                            double * output = NULL, int * reduce_type = NULL, int noutput = 0, Real * maxvel = nullptr, bool copyout = true,
                            bool async = false, void ** vparams = NULL);

        template <typename UpdateFunct>
        __host__ __device__ auto updateParticle(int row, int idx, UpdateFunct update_funct, double dtau, Field<Real> ** fields, int nfields,
                                double * params, double * output, int noutput, bool copyout = true, void ** vparams = NULL);
...
// update particles
template <typename part, typename part_info, typename UpdateFunct>
__global__ void update_particles(perfParticles<part, part_info> * pcl, UpdateFunct update_funct, double dtau, Field<Real> ** fields,
                    int nfields, double * params, double * output, int * reduce_type, int noutput,
                    Real * v2, bool copyout, void **vparams)
{
    int row = blockIdx.x;
    ...
    using return_type = decltype(pcl->updateParticle(row, thread_id, update_funct, dtau, fields, nfields, params, output_thread,
                                noutput, copyout, vparams));
...
template <typename part, typename part_info>
template <typename UpdateFunct>
void perfParticles<part, part_info>::updateParticles(UpdateFunct update_funct, double dtau, Field<Real> ** fields, int nfields, double * params,
                        double * output, int * reduce_type, int noutput, Real * maxvel, bool copyout, bool async, void **vparams)
{
    for (int i = 0; i < noutput; i++)
    {
        if (reduce_type[i] & (SUM | SUM_LOCAL))
...
template <typename part, typename part_info>
template <typename UpdateFunct>
__host__ __device__ auto perfParticles<part, part_info>::updateParticle(int row, int idx, UpdateFunct update_funct, double dtau, Field<Real> ** fields,
                                            int nfields, double * params, double * output, int noutput, bool copyout, void ** vparams)
{
...
template <typename part, typename part_info>
template <typename UpdateFunct>
Real perfParticles<part, part_info>::updateVel(UpdateFunct updateVel_funct, double dtau, Field<Real> ** fields, int nfields,
                            double * params, double * output, int * reduce_type, int noutput, void **vparams)
{
    Real maxvel = 0.;
...
template <typename part, typename part_info>
template <typename UpdateFunct>
void perfParticles<part, part_info>::moveParticles(UpdateFunct move_funct, double dtau, Field<Real> ** fields, int nfields,
                                    double * params, double * output, int * reduce_type, int noutput, void **vparams)
{
